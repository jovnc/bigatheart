...
export async function generateCertificate(eventid, volunteerid) {
  ...
  const doc = new PDFDocument({
    font: ".next/assets/fonts/Butler_Regular.otf",
    layout: "landscape",
    size: "A4",
  });
  ...
  doc.image(".next/assets/images/certificate.jpg", 0, 0, { width: 842 });
  doc.font(".next/assets/fonts/Butler_Regular.otf");
...
export async function generateInvitation(
  ...
  doc.image(".next/assets/images/invitation.jpg", 0, 0, { width: 842 });
  doc.font(".next/assets/fonts/Butler_Regular.otf");
